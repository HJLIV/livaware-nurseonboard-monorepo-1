...
const statCards = [
  ...
  },
  {
    ...
    desc: "Skills Arcade competency achieved",
    icon: Gamepad2,
    accent: "amber",
      ...
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className="text-xs mt-0.5">Applicant → Candidate → Onboarding → Skills Arcade progression</CardDescription>
          </div>
      ...
      <div className="space-y-7">
        ...
        <div className="animate-fade-in-up">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Applicant → Candidate → Onboarding → Skills Arcade lifecycle at a glance
          </p>
        </div>
